...
const ImpactBold: React.FC<ImpactBoldProps> = ({
    ...
    return (
        ...
        >
            ...
            {shouldRender('header') && (
                ...
                >
                    <div 
                        style={{ fontSize: '26pt', fontWeight: 900, letterSpacing: '-0.02em', lineHeight: 1.1, marginBottom: '4px' }}
                        contentEditable 
                    ...
                    {data.headline && (
                        <div 
                            style={{ fontSize: '10.5pt', fontWeight: 500, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '12px' }}
                            contentEditable 
                            suppressContentEditableWarning
                        >
                            {data.headline}
            ...
            {/* Main Content Body */}
            <div style={{ padding: '16px 52px 32px 52px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
                {/* Summary */}
                                    ...
                                    {isHeaderVisible ? (
                                        <div data-block-key={headerKey} data-section-id="experience" data-column="main">
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '2px' }}>
                                                ...
                                                <span style={{ fontSize: '8.5pt', fontWeight: 'bold', color: '#4b5563' }} contentEditable suppressContentEditableWarning>{job.dates}</span>
                                            </div>
                                            <div style={{ fontSize: '8.5pt', marginBottom: '4px' }}>
                                                <strong style={{ color: '#4b5563', fontWeight: 700 }} contentEditable suppressContentEditableWarning>{job.company}</strong>
                                                {job.location && <span style={{ color: '#6b7280' }} contentEditable suppressContentEditableWarning>{` — ${job.location}`}</span>}
                                            </div>
                                        </div>
                                    ) : (
                                        <div style={{ fontStyle: 'italic', fontSize: '8.5pt', color: '#6b7280', marginBottom: '4px' }}>
                                ...
                                <div key={index} style={{ marginBottom: '12px' }}>
                                    {isHeaderVisible ? (
                                        <div data-block-key={headerKey} data-section-id="projects" data-column="main">
                                            ...
                                            {project.meta && (
                                                <div style={{ fontStyle: 'italic', fontSize: '8.5pt', color: '#6b7280', marginBottom: '4px' }} contentEditable suppressContentEditableWarning>
                                                    {project.meta}
                                                </div>
                                            )}
                                        </div>
                            ...
                            return (
                                ...
                                >
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                                        <span style={{ fontWeight: 700, fontSize: '9.5pt', color: '#111827' }} contentEditable suppressContentEditableWarning>{edu.degree}</span>
                                        <span style={{ fontSize: '8.5pt', color: '#6b7280' }} contentEditable suppressContentEditableWarning>{edu.dates}</span>
                                    </div>
                                    <div style={{ fontStyle: 'italic', fontSize: '9pt', color: '#4b5563', fontWeight: 500 }}>
